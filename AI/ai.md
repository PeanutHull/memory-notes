...
1. 理论
   - 规划方法：![](../images/ai/llm-strong-plan.jpg)
     1. CoT
...
#### 开发框架
1. AutoGPT
   - 认识：能够利用llm的能力，自主决策并生成结果的ai智能体的开源项目，是ReAct一个非常强大和自动化的实现，python写的
   - 特点
...
1. 视频应用
   - 大模型
     1. Sora：openai的文生视频
     1. Stable Diffusion：由CompVis、Stability AI和LAION的研究人员于2022年联合发布
     1. DALL-E
   - 应用平台
     1. 国外
