...
##### 网络产品认识
1. vpc是给一堆服务器打通网络用的，cen是给北京和美西、自建IDC之间打通用的
...
1. SSO
   ...
   - CAS：Central Authentication Service 中央认证服务，是一种开放的、易于集成的sso协议，就是没认证会将用户重定向到CAS服务器进行登录后再重定向回去，能够与LDAP、数据库或其他认证机制集成，1998年创建
1. JWT
...
1. SAML：Security Assertion Markup Language，基于XML的支持sso开放标准
#### IM
1. 认知
