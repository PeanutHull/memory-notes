   ...
   - 拥塞控制
     ...
     1. 拥塞策略算法
        - 探测拥塞边缘：以下二者只要判断网络发生了拥塞就设置为当前发送窗口大小的一半
          1. 慢启动：倍增拥塞窗口
          1. 拥塞避免：线增拥塞窗口
        - 快速重传：服务端主动告诉客户端重传，要求接收方在收到一个失序的报文段后立即发出重复确认让发送方知道，降低网络抖动对速率的影响
...
1. 其他
   - 隧道：tunnel，是一种网络通讯协议，在其中使用一种网络协议(即发送协议)，将另一个不同的网络协议封装在负载部分。用于在不兼容的网络上传输数据，或者在不安全网络上提供一个安全路径
