...
1. Service Mesh
   - 认识：云原生时代下的微服务架构，对微服务屏蔽通信的复杂度，解决微服务的通信治理问题，接入对业务无侵入，直接接管tcp和rpc
1. 应用
   - Istio
   - Envoy
     1. 认识：C++编写的云原生高性能边缘代理、中间代理和服务代理，作为专门为微服务架构设计的通信总线，定位是作为Service Mesh的数据平面，接管微服务通信的全部流量，对应用程序屏蔽网络和通信的复杂性
