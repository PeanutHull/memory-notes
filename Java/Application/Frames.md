...
### Spring
1. 官方参考项目
   - spring-mvc-showcase：参考控制器、配置等写法
   - greenhouse：也有很多配置和项目
   - spring-petclinic：用spring boot启动，有很多官方的小例子
   - spring-boot
...
### 微服务
1. 理解：微服务架构是一种架构模式，它提倡将单一应用程序划分成一组小的服务，服务之间互相协调、互相配合，为用户提供最终价值。微服务架构 ≈ 模块化开发 + 分布式计算
1. 组成
...
1. 实例：使用Spring Cloud提供的 服务注册(Eureka)、服务发现(Ribbon)、服务网关(Zuul)三个组件即可以快速入门
   1. 沿用组织中现有的技术体系开发单一职责的微服务————注册中心、服务发现、负载均衡
   1. 服务提供方将地址信息注册到注册中心，调用方将服务地址从注册中心拉下来
   1. 通过门户后端（服务网关）将微服务 API 暴露给门户或移动APP————服务网关
